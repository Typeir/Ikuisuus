 ...
 * @requires @scripts/metadata/generateMonsterMetadata.mjs Monster metadata generator
...
describe('Monster Metadata Generator', () => {
  ...
  describe('Multi-Stat Block Files', () => {
    ...
    it('should extract unique data for each stat block', async () => {
      ...
      const cub = result.find((m: { title: string }) => m.title.includes('Cub'));
      const elder = result.find((m: { title: string }) => m.title.includes('Elder'));
  ...
  describe('Blockquote Spawn Statlets', () => {
    ...
    it('should include the main monster with full stats', async () => {
      ...
      const mainMonster = result.find((m: { title: string }) => m.title.includes('Albedo'));
    ...
    it('should extract spawn statlets with correct sizes', async () => {
      ...
      const petal = result.find((m: { title: string }) => m.title.includes('Petal'));
      const bloom = result.find((m: { title: string }) => m.title.includes('Bloom'));
  ...
  describe('Tag Generation', () => {
    ...
    it('should include creature type in tags', async () => {
      ...
      const hasCreatureTypeTag = monster.tags.some((tag: string) => 
