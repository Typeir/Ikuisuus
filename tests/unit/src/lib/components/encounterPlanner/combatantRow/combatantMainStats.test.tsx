 ...
 * @requires @/lib/components/encounterPlanner/combatantRowMainStats
...
import * as CombatantMainStatsModule from '@/lib/components/encounterPlanner/combatantRow/combatantMainStats';
import { CombatantMainStats } from '@/lib/components/encounterPlanner/combatantRow/combatantMainStats';
