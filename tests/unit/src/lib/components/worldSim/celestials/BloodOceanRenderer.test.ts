...
import { BloodOceanRenderer } from '@/lib/components/worldSim/celestials/BloodOceanRenderer';
import type {
    CelestialBodyData,
    SceneContext,
...
vi.mock('@/lib/components/worldSim/shaders/bloodOcean.vert.glsl', () => ({
  default: 'void main() { gl_Position = vec4(0.0); }',
}));
vi.mock('@/lib/components/worldSim/shaders/bloodOcean.frag.glsl', () => ({
