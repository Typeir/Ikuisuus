...
vi.mock('@/lib/components/mdxEditor/editorCommands', () => ({
  wrapSelection: vi.fn(),
...
import { EditorToolbar } from '@/lib/components/mdxEditor/editorToolbar';
...
describe('EditorToolbar', () => {
  ...
  it('calls wrapSelection when Bold button is clicked', async () => {
    const { wrapSelection } =
      await import('@/lib/components/mdxEditor/editorCommands');
