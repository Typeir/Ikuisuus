/**
 * TODO: Add comprehensive tests for collapsible.tsx
...
describe('collapsible', () => {
  it('should load component module [DUMMY TEST]', async () => {
    try {
      const mod = await import('@/lib/components/mdx/collapsible/collapsible');
      const exported = Object.keys(mod).length;
      expect(exported).toBeGreaterThan(0);
    } catch (error) {
      console.warn(
        '⚠️  DUMMY TEST WARNING: @/lib/components/mdx/collapsible/collapsible',
