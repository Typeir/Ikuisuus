 ...
 * @requires @/modules/metadata-tables/presentation/HeirloomTable/HeirloomTable
 */
...
import HeirloomTableWrapper from '@/modules/metadata-tables/presentation/HeirloomTable/HeirloomTable';
