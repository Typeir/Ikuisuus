/**
 * @fileoverview Unit tests for the OG image API route. Mocks the data layer
 * and renderer. Validates 400 / 404 / 500 / 200 response paths.
 *
...
vi.mock('@/lib/seo/og/data', () => ({
  ...
  resolveOgBackgroundImagePath: vi.fn(() => ''),
}));

vi.mock('@/lib/seo/og/pngConverter', () => ({
  convertToPngDataUri: vi.fn().mockResolvedValue(undefined),
}));
