 ...
 *
 * @module tests/unit/src/modules/library/presentation/components/slots/vocation/Progression.test
 * @version 0.1.0
 * @author Typeir
 * @since 2026-09-06
 */
...
import Progression, { Column, Row } from '@/modules/library/presentation/components/slots/vocation/Progression';
import Vocation from '@/modules/library/presentation/components/slots/vocation/Vocation';
