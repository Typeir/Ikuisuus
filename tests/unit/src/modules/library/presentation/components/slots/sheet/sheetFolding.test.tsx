 ...
 * @module tests/unit/src/modules/library/presentation/components/slots/sheet/sheetFolding.test
 * @version 1.0.0
 * @author Typeir
 * @since 8.0.0
 *
...
import {
  ...
  isCard,
  rebuild,
} from '@/modules/library/presentation/components/slots/sheet/sheetFolding';
