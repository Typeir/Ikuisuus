 ...
 *
 * @module tests/unit/src/modules/library/presentation/components/slots/item/Attributes.test
 * @version 0.1.0
 * @author Typeir
 * @since 2026-09-03
 */
...
import Attributes, {
  ...
  type HeirloomValues,
} from '@/modules/library/presentation/components/slots/item/Attributes';
