 ...
 *
 * @module tests/unit/src/modules/library/presentation/components/slots/utils/columns.test
 * @version 0.1.0
 * @author Typeir
 * @since 2026-09-07
 */

import { elementsNamed, type ColumnProps } from '@/modules/library/presentation/components/slots/utils/columns';
import { Column, Row } from '@/modules/library/presentation/components/slots/vocation/Progression';
