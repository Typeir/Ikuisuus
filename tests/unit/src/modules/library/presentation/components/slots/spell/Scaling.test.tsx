 ...
 * from a higher slot
 *
 * @module tests/unit/src/modules/library/presentation/components/slots/spell/Scaling.test
 * @version 0.1.0
 * @author Typeir
 * @since 2026-09-07
 */

import Scaling from '@/modules/library/presentation/components/slots/spell/Scaling';
