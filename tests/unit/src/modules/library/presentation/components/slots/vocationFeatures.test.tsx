 ...
 *
 * @module tests/unit/src/modules/library/presentation/components/slots/vocationFeatures.test
 * @version 0.1.0
 * @author Typeir
 * @since 2026-09-06
 */

import Feature, { Trait } from '@/modules/library/presentation/components/slots/Feature';
import { Level } from '@/modules/library/presentation/components/slots/slotElements';
import { collectFeatureHeadings } from '@/modules/library/presentation/components/slots/vocationFeatures';
