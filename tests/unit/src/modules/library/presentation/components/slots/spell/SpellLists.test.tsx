 ...
 *
 * @module tests/unit/src/modules/library/presentation/components/slots/spell/SpellLists.test
 * @version 1.0.0
 * @author Typeir
 * @since 2026-09-08
 */
...
import SpellLists from '@/modules/library/presentation/components/slots/spell/SpellLists';
