...
function generateTestTemplate(sourcePath, isComponent) {
...
async function testFileExists(sourcePath) {
...
async function main() {
  ...
  for (const sourceFile of sourceFiles) {
    ...
    if (!hasTest) {
      ...
      const testPath = path.join(ROOT, 'tests', 'unit', sourceFile.replace(/\.(ts|tsx)$/, `.test${ext}`));
