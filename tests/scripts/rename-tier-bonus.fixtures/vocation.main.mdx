---
contentType: vocation
---

import { Collapsible } from '@/lib/components/mdx';
...
While raging, you add your proficiency bonus to Strength checks and Strength saving throws.
