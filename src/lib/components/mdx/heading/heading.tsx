 ...
 */
export function Heading({ level, children, anchor, className }: HeadingProps): JSX.Element {
 ...
 */
export function H1({ children, anchor, className }: Omit<HeadingProps, 'level'>): JSX.Element {
  return <Heading level={1} anchor={anchor} className={className}>{children}</Heading>;
}
 ...
 */
export function H2({ children, anchor, className }: Omit<HeadingProps, 'level'>): JSX.Element {
  return <Heading level={2} anchor={anchor} className={className}>{children}</Heading>;
}
 ...
 */
export function H3({ children, anchor, className }: Omit<HeadingProps, 'level'>): JSX.Element {
  return <Heading level={3} anchor={anchor} className={className}>{children}</Heading>;
}
 ...
 */
export function H4({ children, anchor, className }: Omit<HeadingProps, 'level'>): JSX.Element {
  return <Heading level={4} anchor={anchor} className={className}>{children}</Heading>;
}
 ...
 */
export function H5({ children, anchor, className }: Omit<HeadingProps, 'level'>): JSX.Element {
  return <Heading level={5} anchor={anchor} className={className}>{children}</Heading>;
}
 ...
 */
export function H6({ children, anchor, className }: Omit<HeadingProps, 'level'>): JSX.Element {
  return <Heading level={6} anchor={anchor} className={className}>{children}</Heading>;
}
