/**
 * Simplex 3D Noise — Shared GLSL include (Ashima Arts, MIT license).
 * Provides the `snoise(vec3)` function for 3D simplex noise.
 * Import as a string and prepend to shaders that need noise.
 */
