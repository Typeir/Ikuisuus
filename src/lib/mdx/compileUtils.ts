 ...
 * @property {Record<string, any>|undefined} components - Optional component map for the MDX evaluator
 * @property {EvaluateMdxOptions|undefined} mdxOptions - Optional MDX plugin options to merge with defaults
 * @property {string|undefined} baseUrl - Optional base URL for resolving relative links in MDX
 * @property {boolean} [parseFrontmatter=true] - Whether to parse frontmatter from the MDX source
 */
