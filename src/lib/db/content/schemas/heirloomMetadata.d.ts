 ...
 * @property {string} [weaponDamage] - Weapon damage dice expression (e.g. "1d10").
 * @property {string} [weaponDamageType] - Weapon damage type (e.g. "slashing").
 * @property {string} [versatileDamage] - Versatile damage dice expression (e.g. "1d12").
