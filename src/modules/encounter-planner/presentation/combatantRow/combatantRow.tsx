 ...
 * @requires @/modules/encounter-planner/domain/combat/inProgressCombat.types InProgressCombatant type definition
...
import type { AffixEntry, SpellRef } from '@/modules/encounter-planner/domain/encounters/encounter.types';
import type { InProgressCombatant } from '@/modules/encounter-planner/domain/combat/inProgressCombat.types';
import { computeAwakeningClasses } from '../utils/heroicAwakeningStyles';
import { forceHeroicAwakeningWithAffixes } from '@/modules/encounter-planner/application/factories/combatSnapshot.factory';
