 ...
 * declares
 * @module modules/library/presentation/components/slots/vocation/Progression
 * @version 0.2.0
 * @author Typeir
 * @since 2026-09-06
 */
...
import { elementsNamed, type ColumnProps, type RowProps } from '../utils/columns';
import { flagOf } from '../utils/text';
import { useVocationFeatures } from './vocationFeatures';

export type { ColumnProps, RowProps } from '../utils/columns';
