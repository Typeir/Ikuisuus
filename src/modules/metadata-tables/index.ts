/**
 * @fileoverview Metadata-tables exports.
 * @module src/modules/metadata-tables/index
 * @author Typeir
 * @version 1.0.0
 * @since 1.0.0
 */
...
export { TrinketTable } from './presentation/TrinketTable';
export { useSpellColumns } from './presentation/useSpellColumns';
