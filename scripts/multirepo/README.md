...
**Note**: The hook only warns if _both_ repos have changes. If one repo is clean (no changes), repos can be at different commits without warning — no need for empty sync commits.
