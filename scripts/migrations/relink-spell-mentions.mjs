...
const ALIASES = {
  ...
  // ledger-audit batch, 24-07-2026
  'shadow of moil': 'mantle-of-the-everdark',
  'negative energy flood': 'kalmoras-tide',
  'prismatic spray': 'orbital-cascade',
  'prismatic wall': 'orbital-barriers',
  'color spray': 'chromatic-bloom',
  'enemies abound': 'crown-of-madness',
  'blade of disaster': 'black-quill-of-oblivion',
  'flaming sphere': 'ardent-prism',
  "dragon's breath": 'draconic-bestowal',
  'antipathy sympathy': 'sway',
  'calm emotions': 'sway',
  daylight: 'dawn',
  // barrier -> pall: barriers are walls, palls are worn (author ruling, 24-07-2026)
  "archivist's barrier": 'archivists-pall',
  "archivists' barrier": 'archivists-pall',
  'mental barrier': 'mental-pall',
